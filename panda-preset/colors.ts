...
export const semanticColors = {
  ...
  interactive: {
    primary: {
      DEFAULT: {
        value: { base: '{colors.blue.600}', _dark: '{colors.periwinkle.500}' }
      },
      hovered: {
        value: { base: '{colors.blue.500}', _dark: '{colors.periwinkle.400}' }
      },
      pressed: {
        value: { base: '{colors.blue.700}', _dark: '{colors.periwinkle.600}' }
      },
      // Translucent versions of blue.200 and periwinkle.800 respectively
      disabled: {
        value: {
          base: 'rgba(195, 207, 255, 0.75)',
          _dark: 'rgba(53, 43, 132, 0.75)'
        }
      }
    },
    secondary: {
      ...
      disabled: {
        value: {
          ...
          _dark: 'rgba(31, 31, 35, 0.75)'
        }
      },
      accent: {
        DEFAULT: {
          value: { base: '{colors.blue.600}', _dark: '{colors.periwinkle.400}' }
        },
        hovered: {
          value: { base: '{colors.blue.500}', _dark: '{colors.periwinkle.300}' }
        },
        pressed: {
          value: { base: '{colors.blue.700}', _dark: '{colors.periwinkle.500}' }
        },
        disabled: {
          value: { base: '{colors.navy.400}', _dark: '{colors.navy.500}' }
        }
      }
    },
    tertiary: {
      ...
      disabled: {
        value: {
          base: 'rgba(248, 248, 248, 0.75)',
          _dark: 'rgba(18, 18, 20, 0.75)'
        }
      }
    },
    danger: {
      DEFAULT: {
        value: { base: '{colors.red.600}', _dark: 'rgba(65, 16, 14, 0.75)' }
      },
      ...
      disabled: {
        value: {
          base: 'rgba(250, 208, 206, 0.75)',
          _dark: 'rgba(65, 16, 14, 0.75)'
        }
      }
    }
  },
  ...
  spinner: {
    primary: {
      ...
      track: {
        value: { base: '{colors.blue.100}', _dark: '{colors.periwinkle.950}' }
      }
    },
    onInteractive: {
  ...
  skeleton: {
    ...
    shimmer1: {
      value: { base: 'rgba(255, 255, 255, 0)', _dark: 'rgba(64, 64, 64, 0)' }
    },
    shimmer2: {
      value: {
  ...
  focusBg: {
    value: { base: 'rgba(64, 64, 64, 0.1)', _dark: 'rgba(192, 192, 192, 0.1)' }
  },
  dialogOverlay: {
    value: { base: 'rgba(0, 0, 0, 0.25)', _dark: 'rgba(0, 0, 0, 0.4)' }
  },
