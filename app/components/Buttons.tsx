...
// https://github.com/aptos-labs/graffio/blob/5fea2458e3b3ac53671c3665b0503ff045919bd6/frontend2/src/components/Button/index.tsx
  ...
  (
    ...
    return (
      <Component
        ...
        className={cx(
          buttonStyles({ variant, size, iconOnly, rounded }),
          className
        )}
        {...props}
      >
